        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-8 col-xl-9 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                    <a style="margin-right: 2.5%" href="{{ route('admin.puskesmas.create') }}" class="btn btn-info d-flex align-items-center">
                        ...
                        @foreach ($datas as $result)
                            <tr>
                               ...
                               <td>{{$result->kecamatan}}</td>
                                ...
                                <td>
                                    <a href="{{ route('admin.puskesmas.edit', $result->id) }}"
                                        class="btn btn-sm btn-warning">
                                        <i class="ti ti-pencil"></i>
                                    </a>
                                    <form action="{{ route('admin.puskesmas.delete', $result->id) }}"
