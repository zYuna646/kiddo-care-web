                    ...
                    <tbody>
                        @foreach ($datas as $result)
                            <tr>
                                ...
                                <td>{{ $result->title }}</td>
                                <td>{{$result->KategoriArtikel->name }}</td>
                                <td>
                                ...
                                <td>
                                    <a href="{{ route('admin.artikel.edit', $result->id) }}"
                                        class="btn btn-sm btn-warning">
                                        <i class="ti ti-pencil"></i>
                                    </a>
                                    <form action="{{ route('admin.artikel.delete', $result->id) }}"
        ...
        <div class="card-body">
            <div class="alert alert-warning mb-0" role="alert">
                <div class="d-flex gap-2 align-items-center">
                    ...
                    <p class="mb-0">
                        No {{ $title ?? " "}} data yet. <a href="{{ route('admin.artikel.create') }}">Add</a> now.
                    </p>
                </div>
            </div>
        </div>
