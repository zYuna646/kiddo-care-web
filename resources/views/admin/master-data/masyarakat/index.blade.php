        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-8 col-xl-9 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                    <a style="margin-right: 2.5%" href="{{ route('admin.masyarakat.create') }}" class="btn btn-info d-flex align-items-center">
                        ...
                        @foreach ($datas as $result)
                            <tr>
                               ...
                               <td>{{$result->nik}}</td>
                                ...
                                <td>
                                    <a href="{{ route('admin.admin.edit', $result->id) }}"
                                        class="btn btn-sm btn-warning">
                                        <i class="ti ti-pencil"></i>
                                    </a>
                                    <form action="{{ route('admin.admin.delete', $result->id) }}"
        ...
        <div class="card-body">
            <div class="alert alert-warning mb-0" role="alert">
                <div class="d-flex gap-2 align-items-center">
                    ...
                    <p class="mb-0">
                        No {{ $title ?? " "}} data yet. <a href="{{ route('admin.puskesmas.create') }}">Add</a> now.
                    </p>
                </div>
            </div>
        </div>
