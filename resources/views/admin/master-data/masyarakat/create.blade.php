            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="mb-3">
                            <label class="control-label mb-1">Nomor Kartu Keluarga<span class="text-danger">*</span></label>
                            <input type="text" name="nkk" class="form-control @error('nkk') is-invalid @enderror"
                                placeholder="..." value="{{ old('nkk') }}" />
                            @error('nkk')
                                <small class="invalid-feedback">
                                    {{ $message }}
                                </small>
